...
public class GetCardList extends AsyncTask <Integer, Integer, String>{
...
//    }
    ...
    protected String doInBackground(Integer... ids) {
        ...
        String line = "";
        try {
            System.out.println("> Reading card list data");
            URL url = new URL("http://10.0.2.2:8000/api/card/list/");
        ...
        System.out.println("> End reading card lists");
